    ...
    <div class="container-fluid profile-section row">
      ...
      <div class="col-lg-3 left-nav-profile row">
        ...
        <div class="col-7 user-details">
          <!-- NAMES -->
          <h1 class="display-4 full-name-profile">Gabriel Muresan</h1>
          <h2 class="display-4 username-profile">@gabrielmuresan</h2>
        </div>
        <!-- DESCRIPTION SEGMENT WHICH OCCUPIES A WHOLE ROW, BUT IS ONLY 9 COLUMNS IN WIDTH -->
        <div class="description-profile-container col-sm-12 col-md">
          <p class="description-profile">
            Self-taught graphic designer, computer science student. Always
            lookin' for more to learn.
          </p>
        </div>
        <!-- TAGS SEGMENT -->
        <div class="tags-profile-container col-12">
          ...
          <!-- HERE ARE TAGS -->
          <span class="badge rounded-pill user-tag user-tag-pro">PRO</span>
          <span class="badge rounded-pill user-tag user-tag-2021-award"
            >2021 BEST RATED ASSETS</span
          >
          <span class="badge rounded-pill user-tag user-tag-high-rating"
            >HIGH RATED</span
          >
        </div>
          ...
          <button class="btn btn-success m-1 save-profile-button shadow-none" type="button" onclick="window.location='profile.php';">
            Save Changes
          </button>
      ...
      <div class="col-lg-5 main-content-profile row">
        ...
        <div class="no-content-text-container col-12">
          <form>
            ...
            <input
              ...
              type="text"
              placeholder="Website"
              value="www.gabrielmuresan.studio"
              class="form-control edit-profile-short shadow-none"
              id="urlEdit"
              aria-describedby="emailHelp"
            />
            ...
            <textarea
              ...
              id="bioEdit"
              aria-describedby="emailHelp"
            />Self-taught graphic designer, computer science student. Always lookin' for more to learn.</textarea>
            ...
            <div class="tags-edit-container">
              ...
              <span class="badge rounded-pill user-tag user-tag-high-rating"
                >HIGH RATED</span
              >
              <a href="#"><span class="badge rounded-pill user-tag display-user-tag"
                >+</span
              ></a>
            </div>
          </form>
        ...
        <div class="no-content-text-container col-12">
          <p class="no-content-text">
            Uh Oh... There's nothing here.<br /><span>Explore </span> assets and
            add them to favourites<br />for later.
          </p>
        </div>
